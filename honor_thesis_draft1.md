...
>2. Calculate the gradient of the loss function over the entirety of the training data set and subtract that from $\theta$
>$$ 
>3. Subtract 
>θ = θ − η · ∇θJ(θ)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU0ODU1MTIwMiwxNTQ4NTUxMjAyLC0xOT
