...
$$ p(w_o|w_{o-j},\dots,w_{o+j}; \theta) = \frac{e^{\big(g(w_{o-j}^T\theta,\dots,w_{o+j}^T\theta)\big)}}{ \displaystyle\sum_{i=0}^V exp\big(g(w_i)^T\theta\big)}$$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MTc5NTc2NzQsMTIzNDA1Njc2MCwxNT
