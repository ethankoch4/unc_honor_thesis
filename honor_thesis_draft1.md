...
In order to give a firm understanding of the model I have presented CBOW as using the words on either side of a given word, $w_o$, to predict $w_o$ and thereby generate embeddings. However, often times CBOW, as well as other word embeddings models, will choose $w_o$ to the word directly *after* the context. The input-output pairs are generated in the the
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjgwODI1NTgsNTY2NTUxNjAwLDEyMzQwNT
Y3NjAsMTU0ODU1MTIwMiwtMTk0MjU2NTA5NCwtOTA1NDc3NTIx
LDEyMDgyNTE5NzgsMzgxMjU0ODA4XX0=
-->