...
One may notice in the Skip-Gram model the input-output pairs are both of the same dimension. This is not true of the CBOW model. So, we define a function $g:\ \R_2c$ to be a a concatenating or averaging function which then is multiplied  on a word-level the goal becomes to maximize:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODY1NDc2NzczLDEyMzQwNTY3NjAsMTU0OD
