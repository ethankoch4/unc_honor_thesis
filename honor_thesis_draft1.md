...
In order to give a firm understanding of the model I have presented CBOW as using the words on either side of a given word, $w_o$, to predict $w_o$ and thereby generate embeddings. However, often times CBOW, as well as other word embeddings models, will choose $w_o$ to the word directly 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAyMjIyMjU2LDU2NjU1MTYwMCwxMjM0MD
