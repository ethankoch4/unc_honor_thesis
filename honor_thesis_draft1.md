...
In Word2Vec, Doc2Vec, and Node2Vec, Stochastic Gradient Descent is used as the method to find the parameter
## 2    Intro to Doc2Vec
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk5MTU4MTkxNywtOTA1NDc3NTIxLDEyMD
