...
$$ \{((w_{o-j},\dots,w_{o+j}),\ w_o)\ |\ 0\leq o\leq V,\ j\neq 0\} $$
$$g$$
Where $g$ is a function that concatenates or takes the average of the input vectors
...
### 2.2     DM?
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIyMTA4OTIwNCwxMjA4MjUxOTc4LDM4MT
I1NDgwOF19
-->