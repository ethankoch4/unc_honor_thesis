...
Word2Vec generates embeddings at a word-level. However, this is not useful if one wishes to compare, say, the abstracts of different academic articles 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTYwOTY0NDAwN119
-->